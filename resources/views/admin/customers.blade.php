                            ...
                            <tbody>
                                @foreach ($customers as $customer)
                                    <tr>
                                        ...
                                        <td>{{ $customer->email_addr }}</td>
                                        <td>{{ Str::words($customer->created_at,10,'') }}</td>
                                        <td class="text-end">
                                            <a class="btn btn-sm btn-danger rounded font-sm mt-15" id="dlt_btn_{{ $customer->id }}" onclick="delete_customer({{ $customer->id }})">Delete</a>
                                            <a class="bbtn btn-sm btn-danger rounded font-sm mt-15" type="button" id="loading_btn_{{ $customer->id }}" hidden>

@if (session()->has('admin'))
    ...
    @push('head')
        <title>Visitors New Orders | Baggage Factory</title>
    ...
    @section('section')
        ...
        <section class="content-main">
            <div class="content-header">
                <div>
                    <h2 class="content-title card-title">Visitors New Orders List </h2>
                </div>
            </div>
            @if (count($orders)>0)
                <div class="card mb-4">
                    <header class="card-header">
                        <div class="row gx-3">
                            <div class="col-lg-9 col-md-9 me-auto">
                                <form class="searchform" method="POST" action="{{ route('Admin.get-v-new-order') }}">
                                    @csrf
                                    <div class="input-group">
                                        <input list="search_terms" type="text" name="id" class="form-control" placeholder="Search term">
                            ...
                            <div class="col-lg-3 col-3 col-md-3 d-flex justify-content-end">
                                <div class="col-lg-3 col-3 col-md-3">
                                    <form method="POST" action="{{ route('Admin.get-v-new-orders') }}" class="row">
                                        @csrf
                                ...
                                <tbody id="ruo-result">
                                    @foreach ($orders as $order)
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <a href="{{ url('/admin/visitor-order-detail/'.$order->id) }}" class="btn btn-md rounded font-sm">Detail</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
